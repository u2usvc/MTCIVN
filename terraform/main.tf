...
variable "domain_map" {
  default = {
    ...
    "S01"     = { net = ["L-999", "L-312"], vol_index = 11, ip = "192.168.99.201", cidr = "192.168.99.0/24" },
    "S02"     = { net = ["L-999", "L-313"], vol_index = 12, ip = "192.168.99.202", cidr = "192.168.99.0/24" },
    "S03"     = { net = ["L-999", "L-322"], vol_index = 13, ip = "192.168.99.203", cidr = "192.168.99.0/24" },
    "S04"     = { net = ["L-999", "L-323"], vol_index = 14, ip = "192.168.99.204", cidr = "192.168.99.0/24" }
  }
}
