...
variable "domain_map" {
  default = {
    ...
    "R03_MT_AS6200_121-2_122-2_311-x"             = { net = ["L-121", "L-122", "L-311"], vol_index = 5, ip = ["10.11.21.12", "10.11.22.12", "172.16.98.99"], cidr = ["10.11.21.0/24", "10.11.22.0/24", "172.16.98.0/24"] },
    "R04_MT_AS6200_131-2_132-2_321-x"             = { net = ["L-131", "L-132", "L-321"], vol_index = 6, ip = ["10.11.31.12", "10.11.32.12", "172.16.99.99"], cidr = ["10.11.31.0/24", "10.11.32.0/24", "172.16.99.0/24"] },
    "R01_MT_AS6200_311-1_312-1_313-1"       = { net = ["L-311", "L-312", "L-313"], vol_index = 7, ip = ["172.16.11.11", "192.168.20.11", "192.168.99.99"], cidr = ["172.16.11.0/24", "192.168.20.0/24", "192.168.99.0/24"] },
    "R02_MT_AS6200_323-1_321-2_322-1"       = { net = ["L-323", "L-321", "L-322"], vol_index = 8, ip = ["192.168.30.11", "172.16.99.98", "192.168.97.99"], cidr = ["192.168.30.0/24", "172.16.99.0/24", "192.168.97.0/24"] }
  }
}
