...
variable "domain_map" {
  default = {
    ...
    "R03"     = { net = ["L-999", "L-121", "L-122", "L-311"], vol_index = 5, ip = "192.168.99.103", cidr = "192.168.99.0/24" },
    "R04"     = { net = ["L-999", "L-131", "L-132", "L-321"], vol_index = 6, ip = "192.168.99.104", cidr = "192.168.99.0/24" },

    "R01"     = { net = ["L-999", "L-311", "L-312", "L-313"], vol_index = 7, ip = "192.168.99.101", cidr = "192.168.99.0/24" },
    "R02"     = { net = ["L-999", "L-323", "L-321", "L-322"], vol_index = 8, ip = "192.168.99.102", cidr = "192.168.99.0/24" }
  }
}
